...
from extension.gui.app_frame import create_sarcebleu_trans, create_translate_file, create_translate_pdf, create_tm
...
if __name__ == "__main__":
    ...
    tm_frame = tk.Frame(win_main)
    tm_frame.pack()
    create_tm(tm_frame)
    frames.append(tm_frame)
